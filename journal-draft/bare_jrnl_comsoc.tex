...
\begin{IEEEkeywords}
cognitive radio, robust cluster, game theory, congestion game, distributed, centralised, cluster size control.
\end{IEEEkeywords}
...
Thus, the clusters with more CCCs are in general better as this anticipates a longer time span payload can be exchanged.
...
Then the formal description of robust clustering problem in CRN and the characteristics of the problem are given in Section~\ref{problem}.
