...
The simulation in the large CRN network confirms the conclusion made based on the simulation in the small CRN network, which is that the average number of CCs along is not able to denote the robustness of the clusters, because the cluster size and the constitution of the cluster also affect the robustness.
