...
Cluster size also plays a part in transmission power consumption~\cite{clustering_globecom11, EnergyEfficientClusteringRouting_2015}.
...
We assume the primary users change their operation channels slowly thus we omit the time index for the spectrum availability. 
