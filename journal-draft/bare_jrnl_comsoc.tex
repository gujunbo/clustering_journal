...
The above observation shows that the average number of CCs of non-singleton clusters doesn't necessarily illustrate the robustness  of cluster against increasingly active PRs, \ie SOC obtains the largest average CCs, but generates the most vulnerable clusters.
