...
Then the robust clustering problem is to find a subcollection $\mathcal{S}' \subseteq \mathcal{S}$, so that the sum of the numbers of CCs of the formed clusters $\sum_{C\in \mathcal{S}'} f(C)$ is maximized.
