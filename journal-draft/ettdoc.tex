...
In the context of cognitive radio netowrks, a formed cluster helps the participants not only improve spectrum sensing accuracy, but also coordinate channel switch operation when primary users are detected by at least one secondary user in that cluster. 
Then all the cluster members can stop payload transmission swiftly and vacate the operating channel ~\cite{willkomm08}.
