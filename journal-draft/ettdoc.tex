...
%Thus we consider the clustering problem at some point in time given some degree of information of the availability of the control channels.
...
In particular, a cluster consists of a cluster head $h(C)$ and a number of cluster members.
