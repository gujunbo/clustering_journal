...
Besides, clusters benefit channel switching when primary users are detected by at least one secondary user in that cluster, then all the cluster members can stop payload transmission swiftly and vacate the operating channel ~\cite{willkomm08}.
