...
%Each cluster complies with the definition in , whose number of CCs in a cluster $C$ is $f(C)$.
...
In fact, the upper bound for the number of steps which are actually involved in this process is much smaller than $N^3$.
